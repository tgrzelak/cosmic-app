...
public class CreatorXLS<T> {
    ...
    public void createFile(List<T> series, String path, String fileName) throws IOException, InvocationTargetException, IllegalAccessException {

        //tworze objekt reprezentujacy caly excel
